...
import (
	...
	"github.com/Zoey8/file-rotatelogs/internal/option"
)
...
const (
	...
	optkeyFileNameExtension = "file-name-extension"
)
...
func WithFileNameExtension(e string) Option {
	return option.New(optkeyFileNameExtension, e)
}
